...
const AdminOverview = () => {
  ...
  if (isLoading) return <div className="p-10 animate-pulse text-slate-400 font-bold">Loading Analytics...</div>;
  ...
  const COLORS = ["#10B981", "#F59E0B", "#EF4444"]; // Approved, Pending, Rejected colors
  ...
  return (
    <div className="p-6 md:p-10 bg-slate-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        ...
        <StatCard title="Active Clubs" value={stats.totalClubs} icon={<FaLayerGroup />} color="purple" />
        <StatCard title="Events Held" value={stats.totalEvents} icon={<FaCalendarCheck />} color="emerald" />
        <StatCard title="Total Revenue" value={`$${stats.totalRevenue}`} icon={<FaDollarSign />} color="rose" />
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* 2. Bar Chart - Membership Density */}
